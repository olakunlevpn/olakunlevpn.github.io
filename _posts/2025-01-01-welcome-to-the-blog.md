...
This site runs on Jekyll with the Libretto theme, hosted free on GitHub Pages. The RSS feed at [/feed.xml](/feed.xml) updates on every build, and a small GitHub Action pulls the latest posts straight onto my [profile README](https://github.com/olakunlevpn). Write once, it shows up in both places. That's the kind of thing worth writing down.
